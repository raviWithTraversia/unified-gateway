...
const getUserProfile = async (req,res) => {
  ...
  let userData = await userModel.find({company_ID:company_ID}).populate('roleId', 'name type').populate({
    path: 'company_ID',
    model: 'Company',
    populate: {
      path: 'parent',
...
const filterUserData= userData.filter(user=>user.roleId.name=="Agency")
