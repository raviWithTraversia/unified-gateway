...
const ssrServiceV1_1 = require("./ssr.service v1-1");
...
const flightSerchLogServices = require("../flightSearchLog/flightSearchLog.services");
...
const specialServiceReq = async (req, res) => {
  try {
    const result = await ssrServiceV1_1.specialServiceReqV1_1(req, res);
