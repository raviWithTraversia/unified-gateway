...
flight_booking_route.post('/flightbooking/manuallyUpdateBookingStatus',auth, flight.manuallyUpdateBookingStatus);
...
flight_booking_route.post('/flight/import-pnr-cart-save',auth,flight.importPnrService);
