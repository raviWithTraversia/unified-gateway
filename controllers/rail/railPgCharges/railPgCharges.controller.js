const pgChargesServices = require('./railPgCharges.service');
...
const editPgcharges = async (req, res) => {
  try {
    ...
    } else if (result.response == 'Payment gateway charges for this company and provider already exist'||result.response=="Change PaymentGetWayProvider") {
      apiErrorres(
        res,
        result.response,
        ServerStatusCode.PRECONDITION_FAILED,
